...
public abstract class RequestPlugin extends Plugin {
  ...
  public final LifecyclePoint getLifecyclePoint() {
    return LifecyclePoint.BEFORE_SEND_REQUEST;
  }

  @Override
  public Object doPluginTask(String data, PluginContext context) {
    return preProcessRequest(data, context);
  }
   ...
   * @return
   */
  public abstract Object preProcessRequest(String soapRequest, PluginContext context);
}
